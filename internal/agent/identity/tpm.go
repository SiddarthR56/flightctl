...
func (t *tpmProvider) StoreCSR(csr []byte) error {
	return storeCSR(t.rw, t.clientCSRPath, csr)
}

func (t *tpmProvider) LoadCSR() ([]byte, error) {
	return loadCSR(t.rw, t.clientCSRPath)
}
